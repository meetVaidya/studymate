...
export default function AuthPage() {
    ...
    return (
        <div className="flex min-h-screen bg-slate-100 font-mono">
            {/* Left side */}
            <div className="w-1/2 flex flex-col justify-between p-10 bg-slate-100 text-white">
                <div>
                    <h1 className="text-xl font-bold flex items-center text-black">
                        <span className="mr-2"></span> AI4STUDY
                    </h1>
                </div>
            ...
            {/* Right side */}
            <div className="w-1/2 bg-[#E7E2D2] flex items-center justify-center">
                <div className="bg-slate-100 p-10 rounded-lg shadow-lg w-96">
